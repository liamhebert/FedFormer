...
class SACTrainer(TorchTrainer, LossFunction):
    ...
    def fuse(self, other):
        self.qf1.fuse(other.qf1)
        self.qf2.fuse(other.qf2)
    ...
    def compute_loss(
        ...
        z, tanh_z = (dist.rsample_with_pre_tanh_value())
        log_pi = dist.log_prob(value=tanh_z, pre_tanh_value=z)
        ...
        z, new_next_actions = (next_dist.rsample_with_pre_tanh_value())
        new_log_pi = next_dist.log_prob(value=new_next_actions, pre_tanh_value=z)
